  ...
  function generateInvoice() {
    ...
    <body>
        <div class="container mt-1">
            <h3 class="text-center mb-0" id="savePdfButton">BABA SAREE CENTER</h3>
            <p class="text-center mt-0 mb-0">PNo. 7782011528</p>
            <h3 class="text-center mb-0" id="savePdfButton">BABA HOSIERY</h3>
            <p class="text-center mt-0">PNo. 8877151344</p>
    ...
    <p class="mb-0">Total Qty: ${getTotalQty()}</p>
     ...
     <h4 style="text-align: left;" class="mb-0">Total Cost: <span style="float: right;"> ₹${totalCost.toFixed(2)}</span></h4>
